...
func _on_timer_timeout():
	...
	if live_time > 5:
		py_sprite.set_deferred('visible', false)
		long_live_sprite.set_deferred('visible', true)
...
#		botInArea-=1
	# 族群過小死亡
		...
		pub_col.set_deferred('disabled', true)
		py_sprite.set_deferred('visible', false)
		long_live_sprite.set_deferred('visible', false)
		live_time=0
#		botInArea+=1
	# 族群過大死亡
